...
def extract_custom_properties(docx_path):
    """
    Extract basic metadata (core properties) from a .docx file.
    """
    try:
        ...
        return {
            ...
            "last_modified": properties.modified,
        }
    except ImportError:
        logging.warning("python-docx is not installed. Skipping custom properties extraction.")
        return {}
    except Exception as e:
        logging.error(f"Error extracting custom properties for {docx_path}: {e}")
        return {}


def process_doc_and_docx_files(input_dir, output_dir):
    """
    Processes .doc and .docx files to extract content and metadata.
    """
            ...
            if file.lower().endswith((".doc", ".docx")):
                ...
                try:
                    ...
                    if file.lower().endswith(".docx"):
                        ...
                        custom_properties = extract_custom_properties(input_path)
                    else:
                        # Process .doc file
...
if __name__ == "__main__":
    ...
    # Process files
    process_doc_and_docx_files(input_dir, output_dir)