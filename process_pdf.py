...
def process_pdf_files(
    ...
    """
    Processes all supported PDF files in the input directory and saves extracted content to the output directory.
...
def process_pdf_file(
    ...
    """
    Processes a single PDF file and saves the output in the specified output directory.
    """
    try:
        ...
        logging.info(f"Processed PDF file: {input_file}")
    except Exception as e:
        logging.error(f"Error processing PDF file {input_file}: {e}")
        # Optionally log failed file or handle as desired
